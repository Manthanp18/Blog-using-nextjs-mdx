...
import image from './mailchimp.png'
import image2 from './any.png'
import image3 from './amazon1.png'
import measureImg from './measure.png'

export const meta = {
  title: '6 Tips To Create The Perfect User Onboarding Checklist',
  description: `Customer engagement is an important goal of everyone who has a product out there. Customer engagement is only possible if your customer is well versed with your product.`,
